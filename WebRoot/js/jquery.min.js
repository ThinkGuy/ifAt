...
(function(e, undefined) {
    ...
    function(e, undefined) {
        ...
        c = ot.setDocument = function(e) {
            ...
            r = t.parentWindow;
            return t !== p && 9 === t.nodeType && t.documentElement ? (p = t, f = t.documentElement, h = !s(t), r && r.frameElement && r.attachEvent("onbeforeunload",
            function() {
                c()
            }), n.attributes = lt(function(e) {
                return e.innerHTML = "<a href='#'></a>",
                ct("type|href|height|width", ft, "#" === e.firstChild.getAttribute("href")),
            ...
            g = [], d = [], (n.qsa = st(t.querySelectorAll)) && (lt(function(e) {
                ...
                m.call(e, "[s!='']:x"),
                g.push("!=", I)
            }), d = d.length && RegExp(d.join("|")), g = g.length && RegExp(g.join("|")), y = st(f.contains) || f.compareDocumentPosition ?
            function(e, t) {
        ...
        function Ct(e, t, n, r, i, o) {
            ...
            ut(function(o, s, a, u) {
                ...
                } else y = Tt(y === s ? y.splice(d, y.length) : y),
            ...
            if (!o && 1 === f.length) {
                ...
                while (s--) {
                    ...
                    if ((p = i.find[c]) && (o = p(l.matches[0].replace(nt, rt), U.test(u[0].type) && t.parentNode || t))) {
                        if (u.splice(s, 1), e = o.length && xt(u), !e) return O.apply(r, o),
                        r;
                        break
                    }
                }
    ...
    x.fn.extend({
        ...
        promise: function(e, t) {
            ...
            e = e || "fx";
            while (s--) n = H.get(o[s], e + "queueHooks"),
    ...
    x.fn.extend({
        ...
        domManip: function(e, t, n) {
            ...
            if (c && (r = x.buildFragment(e, this[0].ownerDocument, !1, !n && this), i = r.firstChild, 1 === r.childNodes.length && (r = i), i)) {
                ...
                at.test(a.type || "") && !H.access(a, "globalEval") && x.contains(u, a) && (a.src ? x._evalUrl(a.src) : x.globalEval(a.textContent.replace(lt, "")))
            }
            return this
        }
    }),
    ...
    function qt(e, t) {
        ...
        a = e.length;
        for (; a > s; s++) r = e[s],
        r.style && (o[s] = H.get(r, "olddisplay"), n = r.style.display, t ? (o[s] || "none" !== n || (r.style.display = ""), "" === r.style.display && Lt(r) && (o[s] = H.access(r, "olddisplay", Rt(r.nodeName)))) : o[s] || (i = Lt(r), (n && "none" !== n || !i) && H.set(r, "olddisplay", i ? n: x.css(r, "display"))));
        for (s = 0; a > s; s++) r = e[s],
    ...
    x.fn.extend({
        ...
        toggle: function(e) {
            ...
            return this.each(function() { (t ? e: Lt(this)) ? x(this).show() : x(this).hide()
            })
        }
    }),
    x.extend({
    ...
    x.fn.extend({
        ...
        animate: function(e, t, n, r) {
            ...
            s = function() {
                ...
                e), o); (i || H.get(this, "finish")) && t.stop(!0)
            };
            return s.finish = s,
